...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMvcContext context) // injeção de dependencia, quando SeedingSevice for criado automaticamente ele vai receber uma instacia do context
        {
            _context = context;
        }
